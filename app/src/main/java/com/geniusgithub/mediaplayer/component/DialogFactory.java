...
public class DialogFactory {
    ...
    protected static class DeviceViewHolder{
        ...
        public void bindView(View view){
            mTVManuFacture = view.findViewById(R.id.tv_mfact);
            mTVModelName = view.findViewById(R.id.tv_mname);
            mTVModelDescription = view.findViewById(R.id.tv_desc);
            mTVLocation = view.findViewById(R.id.tv_url);
            mTVUDN = view.findViewById(R.id.tv_udn);
        }
