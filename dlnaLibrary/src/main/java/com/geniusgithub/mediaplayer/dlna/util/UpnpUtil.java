...
//	}
	...
	public static boolean isMediaRenderDevice(Device device){
        return "urn:schemas-upnp-org:device:MediaRenderer:1".equalsIgnoreCase(device.getDeviceType());
    }
	...
	public static boolean isAudioItem(String objectClass){
        return isUPnPClassStartWith(objectClass, AUDIO_OBJECT) || isUPnPClassStartWith(objectClass, AUDIO_OBJECT1);
    }
	...
	public static boolean isVideoItem(String objectClass){
        return isUPnPClassStartWith(objectClass, VIDEO_OBJECT) || isUPnPClassStartWith(objectClass, VIDEO_OBJECT1);
    }
	...
	public static boolean isPictureItem(String objectClass){
        return isUPnPClassStartWith(objectClass, PHOTO_OBJECT) || isUPnPClassStartWith(objectClass, PHOTO_OBJECT1);
    }
	...
	public static boolean isFolderItem(String objectClass){
        return isUPnPClassStartWith(objectClass, FOLDER_OBJECT);
    }
