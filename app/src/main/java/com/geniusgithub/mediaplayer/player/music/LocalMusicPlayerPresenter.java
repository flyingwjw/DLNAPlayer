...
public class LocalMusicPlayerPresenter extends MusicPlayerPresenter implements LrcDownLoadHelper.ILRCDownLoadCallback{

    private final static String TAG = LocalMusicPlayerPresenter.class.getSimpleName();
    ...
    public LocalMusicPlayerPresenter(){
