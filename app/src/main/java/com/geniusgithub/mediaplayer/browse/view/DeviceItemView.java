...
public class DeviceItemView extends LinearLayout implements IBaseAdapterView<Device>, View.OnClickListener{
    ...
    public interface onDeviceItemClickListener extends OnItemClickListener<Device> {
    }

    public interface onDeviceDetialClickListener {
        void onDetailViewClick(Device device);
    }
